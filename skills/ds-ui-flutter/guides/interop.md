...
+            GlobalDSLocalizations.delegate,
+            GlobalMaterialLocalizations.delegate,
+            GlobalCupertinoLocalizations.delegate,
+            GlobalWidgetsLocalizations.delegate,
+          ],
+          builder: (context, child) {
+            return DSAppBuilder(child: child!);
+          },
+        );
+      },
+    );
...
The default Material `ThemeData` created by `DSApp` is:
...
The default `CupertinoThemeData` created by `DSApp` is:
