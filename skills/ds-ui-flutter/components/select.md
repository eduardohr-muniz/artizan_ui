    ...
    return ConstrainedBox(
      ...
      child: DSSelect<String>(
        ...
        options: [
          ...
          ...fruits.entries
              .map((e) => DSOption(value: e.key, child: Text(e.value))),
        ],
...
class SelectFormField extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return DSSelectFormField<String>(
      id: 'email',
      minWidth: 350,
      initialValue: null,
      options: verifiedEmails
          .map((email) => DSOption(value: email, child: Text(email)))
          .toList(),
...
class _SelectWithSearchState extends State<SelectWithSearch> {
  ...
  @override
  Widget build(BuildContext context) {
    return DSSelect<String>.withSearch(
      minWidth: 180,
      maxWidth: 300,
        ...
        editable: [
          ...
          DSSelect(
            options: ['none', ...verifiedEmails].map(
              (e) => DSOption(value: e, child: Text(e.toString())),
            ),
            ...
            child: Column(
              ...
              children: [
                DSSelectFormField(
                  ...
                  options: verifiedEmails
                      .map(
                        (email) => DSOption(value: email, child: Text(email)),
                      )
                      .toList(),
                  selectedOptionBuilder: (context, value) => value == 'none'
                      ? const Text('Select a verified email to display')
