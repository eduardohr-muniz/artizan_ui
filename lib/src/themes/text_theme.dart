...
extension DSTextThemeTokens on DSTextTheme {
  ...
  TextStyle get titleMedium => custom[_kTitleMedium] ?? _fallback(fontSize: 18, fontWeight: FontWeight.w600, height: 1.375, letterSpacing: 0);
  ...
  TextStyle get bodyMedium => custom[_kBodyMedium] ?? _fallback(fontSize: 14, fontWeight: FontWeight.w400, height: 1.5, letterSpacing: 0);
  ...
  TextStyle get labelMedium => custom[_kLabelMedium] ?? _fallback(fontSize: 12, fontWeight: FontWeight.w600, height: 1.33, letterSpacing: 0.1);
